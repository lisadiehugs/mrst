...
switch scenario
    case 1
    % 4 horizontal and 4 vertical fractures (orthogoal), 4 on domain boundary
    fl = [0, 0, 0, 99; 
          33, 0, 33, 99;
          66, 0, 66, 99;
          99, 0 , 99, 99;
          ...
          0, 33, 99, 33;
          0, 66, 99, 66;
          0, 99, 99, 99]; % fractures lines in [x1 y1 x2 y2] format.
...
coarseDims = [9 9]; 
dof_frac = 36; % Number of coarse blocks in the fracture grid
