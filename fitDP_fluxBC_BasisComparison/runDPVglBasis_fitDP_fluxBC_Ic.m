function [G, CG, basis_out, pvOut] = runDPVglBasis_fitDP_fluxBC_Ic(K_frac, curK)
%% test case for comparison with dual-porosity model
 ...
 fl = [
    ...
    fracture.aperture = 1/50; % Fracture aperture
    gravity off
    ...
    [CG, CGf] = getRsbGridsHFM(G, fracture.network, 'pm' , pm,...
        'dof_frac',dof_frac, ...
        'fracSupportRadius', 8, 'removeCenters', false); % 
    if (curK ==1)
